...
public class SettingsFragment extends PreferenceFragmentCompat {
    private static final String DIALOG_FRAGMENT_TAG = SettingsFragment.class.getSimpleName() + ".DIALOG";
    ...
    private static final int PREF_IMAGE_DELAY_S_DEFAULT = 10;
    ...
    public static int getImageDelaySeconds(Context context) {
        ...
        return prefs.getInt(PREF_IMAGE_DELAY_S, PREF_IMAGE_DELAY_S_DEFAULT);
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        SeekBarPreference imageDelayPref = requirePreference("preference_image_delay");
        imageDelayPref.setDefaultValue(PREF_IMAGE_DELAY_S_DEFAULT);
        imageDelayPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                preference.setSummary(String.format("%d seconds", progress));
                return true;
            }
        });
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        final DialogFragment f = preference instanceof NumberPickerPreference ? NumberPickerPreferenceDialogFragment.newInstance(preference.getKey()) : null;
